...
Promoscreen.prototype.create = function () {
  ...
  var gameLogoPlaceHolder = this.game.add.text(GAME_SCREEN_WIDTH / 2, GAME_SCREEN_HEIGHT * 0.4, '(logo here)', {fill: 'white', font: '24px Georgia, serif'})
  gameLogoPlaceHolder.anchor.set(0.5);
  gameLogoPlaceHolder.align = 'center';

  var beginText = this.game.add.text(GAME_SCREEN_WIDTH / 2, GAME_SCREEN_HEIGHT * 0.8, 'Press any Button to Begin!', {fill: 'white', font: '48px Georgia, serif'})
